...
namespace LibraryAPI.Services.Graph
{
    public class LoanServiceGraph : ILoanServiceGraph
    {
        private readonly ILoanRepositoryGraph _loanRepository;

        public LoanServiceGraph(ILoanRepositoryGraph loanRepository)
        {
